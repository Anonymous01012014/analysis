	 ...
	 */
	 public function getTTAvgCount($initialTimeShift,$endTimeShift){
 		...
 		$query = "SELECT        AVG(dbo.travel.travel_time) AS travel_time, COUNT(dbo.travel.travel_time) AS travel_count, [from].station_id
					...
					WHERE        (dbo.travel.is_valid = 1) AND (dbo.travel.is_valid = 1) AND ( pass_from.passing_time >= '2014-06-27 ".$startHours.":".$initialTimeShift.":24.000' AND pass_from.passing_time <= '2014-06-27 ".$endHours.":".$endTimeShift.":24.000')
